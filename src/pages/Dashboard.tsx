...
const Dashboard: React.FC = () => {
        ...
        const timer = setTimeout(() => {
            ...
            if (!user) {
                setUser({
                    ...
                    role: 'superadmin',
                    institutionName: 'Telmeez Academy',
    ...
    return (
        <div className="min-h-screen bg-gray-50 flex">
            {/* Sidebar */}
            <motion.div
                className={`fixed inset-y-0 left-0 z-50 bg-white transform transition-all duration-300 ease-in-out h-screen lg:relative ${showSidebar ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'
                    }`}
                animate={{
                ...
                <div className="flex flex-col h-full">
                    ...
                    >
                                ...
                                {(!isSidebarCollapsed || window.innerWidth < 1024) && (
                                    ...
                                    >
                                        <motion.h1
                                            ...
                                            className="text-lg font-bold bg-gradient-to-r from-gray-900 via-blue-800 to-purple-800 bg-clip-text text-transparent whitespace-nowrap"
                                        >
                                        ...
                                        <motion.p
                                            ...
                                            className="text-xs text-gray-600 font-medium flex items-center whitespace-nowrap"
                                        >
                        ...
                        <button
                            ...
                            className="lg:hidden absolute top-4 right-4 p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-500 transition-colors duration-200"
                        ...
                        <motion.button
                            ...
                            className="absolute -right-3 focus:outline-none top-1/2 transform -translate-y-1/2 w-6 h-6 bg-white border border-gray-200 rounded-full shadow-md flex items-center justify-center hover:shadow-lg transition-all duration-200 hover:scale-110 z-10 lg:flex hidden"
                    ...
                    <div className="flex-1 overflow-y-auto border-r border-gray-200">
                        <nav className="px-3 space-y-1 py-6">
                            <motion.button
                                ...
                                className={`w-full flex items-center space-x-3 focus:outline-none border-none px-4 py-3.5 rounded-xl text-left transition-all duration-300 group relative overflow-hidden ${activeTab === 'overview'
                                ...
                                layout
                            >
                                <div className={`relative z-20 ${activeTab === 'overview' ? 'text-white' : 'text-gray-500 group-hover:text-blue-600'} transition-colors duration-300`}>
                    ...
                    <motion.div
                        className="flex-shrink-0 p-4 border-t border-r border-gray-200"
                        layout
                    >
                        <motion.button
                            type='button'
                            onClick={() => setShowSignOutConfirmation(true)}
                            className="w-full flex items-center space-x-3 border-none focus:outline-none px-4 py-3.5 rounded-xl text-left transition-all duration-300 group relative overflow-hidden text-gray-600 hover:bg-gradient-to-r hover:from-red-50 hover:to-pink-50 hover:text-red-700 hover:shadow-md"
                            whileHover={{ x: 4, scale: 1.02 }}
                            whileTap={{ scale: 0.98 }}
                            layout
                        >
                            <div className="relative z-10 text-gray-500 group-hover:text-red-600 transition-colors duration-300">
            ...
            {/* Main Content */}
            <div className="flex flex-col flex-1 h-screen overflow-y-auto lg:ml-0">
                {/* Top Header */}
                <header className="bg-white shadow-sm border-b border-gray-200 px-4 sm:px-6 py-4">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-2 sm:space-x-4 ml-auto">
                            ...
                            <button
                                type='button'
                                className="relative p-2 text-gray-400 hover:text-gray-500 hover:bg-gray-100 rounded-md focus:outline-none border-none transition-colors duration-200"
                            ...
                            <div className="relative group" ref={profileDropdownRef}>
                                <button
                                    ...
                                    type="button"
                                    className="flex items-center space-x-2 sm:space-x-3 p-2 rounded-lg hover:bg-gray-100 focus:outline-none transition-all duration-300 font-medium"
                                    onClick={(e) => {
                                        e.stopPropagation();
                                ...
                                >
                                    ...
                                    >
                                        <FaUserCog className="w-4 h-4 mr-3 text-gray-400" />
                    ...
                    <div className="max-w-7xl mx-auto">
                        ...
                        <div className="mb-6 sm:mb-8">
                            ...
                            <p className="text-gray-600 text-sm sm:text-base">
                                Here's what's happening with your {user.institutionName ? user.institutionName : 'Telmeez'} account today.
                            </p>
                        </div>
                    </div>
                </main>
