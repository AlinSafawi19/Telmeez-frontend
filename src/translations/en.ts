export const en = {
    ...
    cookie_banner: {
        ...
        customize: "Customize",
        necessary: "Necessary",
        necessary_desc: "Essential cookies that enable core functionality. The website cannot function properly without these cookies. This includes language preference, scroll position, and FAQ section states.",
        analytics: "Analytics",
