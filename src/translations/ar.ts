export const ar = {
    ...
    about: {
        ...
        press: {
            ...
            whish_integration: {
                title: "تلميز تطلق دفع Whish Money",
                date: "مارس 2026",
                source: "إعلان رسمي من تلميز",
                description: "يسر تلميز أن تعلن عن دمج Whish Money كطريقة دفع جديدة. تعزز هذه الشراكة خيارات الدفع لدينا، مما يوفر للمستخدمين طريقة سلسة وآمنة لإتمام معاملاتهم باستخدام منصة Whish Money الشهيرة. يدعم التكامل كلاً من الحسابات الشخصية وحسابات الأعمال، مما يسهل على عملائنا إدارة مدفوعاتهم.",
                new_feature: "ميزة جديدة",
                payment_integration: "تكامل الدفع"
            },
            mobile_app: {
                title: "تطبيق تلميز للجوال متوفر الآن",
                date: "أبريل 2026",
                source: "تحديث منتج تلميز",
                description: "يسرنا أن نعلن عن إطلاق تطبيقنا للجوال، مما يجلب ميزات إدارة التعليم القوية من تلميز إلى متناول يدك. يوفر التطبيق وصولاً سلساً إلى جميع ميزات المنصة، بما في ذلك الإشعارات في الوقت الفعلي، وتتبع الحضور، والتواصل الفوري بين المشرفين والمعلمين وأولياء الأمور والطلاب.",
                new_feature: "تطبيق الجوال",
    ...
    testimonials: {
        ...
        nofeedbacks: {
            ...
            right: {
                ...
                tag: "عرض لفترة محدودة - انضم إلى برنامج الرواد",
                pioneers: {
                    first: "أ",
                    second: "ب",
                    third: "ج"
    ...
    comingSoon: {
        title: "قريباً",
        description: "تلميز هو منصة تعليمية من الجيل الجديد تُحدث تحولاً في تجربة التعليم من خلال تواصل سلس، تحليلات ذكية، وتجربة استخدام بديهية للمدارس والمعلمين والطلاب. كن من أوائل من يختبرون مستقبل التعليم."
    }
}; 