...
const Demo: React.FC = () => {
    ...
    const t = translations[currentLanguage].demo;
    ...
    return (
        <div className="container mx-auto px-4 relative py-20 bg-gradient-to-b from-blue-50 to-indigo-100 relative overflow-hidden min-h-screen">
