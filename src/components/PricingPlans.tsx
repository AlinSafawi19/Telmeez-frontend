    ...
    const plans: Plan[] = [
        {
            ...
            features: t.plans.starter.features.map((text: string) => ({ text, included: true })),
        },
        {
            id: 'standard',
            ...
            features: t.plans.standard.features.map((text: string) => ({ text, included: true })),
            recommended: true,
        },
        {
            id: 'enterprise',
            ...
            features: t.plans.enterprise.features.map((text: string) => ({ text, included: true })),
        },
    ];
